...
class Block_2 extends Component {
  ...
  render() {
    return (
      <section
        className="Advogrand-b2"
        style={{ backgroundImage: `url(${background})` }}
        ref={this.getSectionRef}
      >
        <div className="Advogrand-b2_content">
          <div className="Advogrand-b2_content--firstBlock">
            Годовой абонемент на услуги
            <br />
            <b style={{ fontWeight: 800, fontSize: '40px' }}>«ЛИЧНОГО ЮРИСТА»</b>
          </div>
          <div className="Advogrand-b2_content--secondBlock">
            ...
            всего
            {' '}
            <b>за 12 рублей в день</b>
          </div>
          <button type="button" className="Advogrand-b2_content--button">
            Хочу «личного юриста»!
          </button>
        </div>
