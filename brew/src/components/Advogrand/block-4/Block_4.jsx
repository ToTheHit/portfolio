...
class Block_4 extends Component {
  ...
  render() {
    return (
      <section
        className="Advogrand-b4"
        style={{ backgroundImage: `url(${background})` }}
        ref={this.getSectionRef}
      >
        <h2 className="Advogrand-b4_title">О сервисе Advogrand</h2>
        <div className="Advogrand-b4_description">
          В составе нашей команды трудятся профессионалы, имеющие огромный опыт реальной юридической
          практики.
          Благодаря этому мы всегда можем найти юридически верное решение, защищающее интересы,
          сглаживающее
          конфликтные ситуации.
          <br />
          <br />
          Наше абонентское обслуживание позволяет сохранить нашим клиентам время, деньги и душевное
          спокойствие,
        ...
        <div className="Advogrand-b4_data">
          <div className="Advogrand-b4_data--item">
            ...
            <div className="Advogrand-b4_data--item_text">
              лет на российском
              <br />
              рынке
            </div>
