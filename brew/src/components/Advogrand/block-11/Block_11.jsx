      ...
      <section className="Advogrand-b11" ref={this.getSectionRef}>
        ...
        <div className="Advogrand-b11_content">
          <div className="Advogrand-b11_content--left">
            <div className="Advogrand-b11_content--left_title">
              Напишите нам письмо или задайте
              <br />
              свой
              вопрос
            </div>
            ...
            <div className="Advogrand-b11_content--left_recall">
              Перезвоним вам в течении 5 минут
            </div>
          </div>
          <div className="Advogrand-b11_content--right">
            ...
            <div className="Advogrand-b11_content--right_phone">
              <div className="Advogrand-b11_content--right_phone-text">
                Телефон для покупки карт:
              </div>
