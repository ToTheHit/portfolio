  ...
  render() {
    return (
      <section className="Advogrand-b6" ref={this.getSectionRef}>
        <h2 className="Advogrand-b6_title">
          Преимущество сервиса Advogrand
          <br />
          по сравнению с
          другими юридическими компаниями
        </h2>
        <div className="Advogrand-b6_table">
          ...
          <div className="Advogrand-b6_table--column_2">
            <div className="Advogrand-b6_table--column_2--item" style={{ fontSize: '14px' }}>
              <b>Advogrand</b>
            </div>
          ...
          <div className="Advogrand-b6_table--column_3">
            <div className="Advogrand-b6_table--column_3--item" style={{ fontSize: '14px' }}>
              <b>
                Юридические
                компании
              </b>
          ...
          <div className="Advogrand-b6_table--column_4">
            <div className="Advogrand-b6_table--column_4--item" style={{ fontSize: '16px' }}>
              <b>
                Нашими
                услугами пользуются:
              </b>
            ...
            <div className="Advogrand-b6_table--column_4--item">
              <div
                className="Advogrand-b6_table--column_4--item_pic"
                style={{ backgroundImage: `url(${pic1})` }}
              />
              <div className="Advogrand-b6_table--column_4--item_text">
                <b>208 000</b>
                {' '}
                - мужчин
              </div>
