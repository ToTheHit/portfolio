        ...
        <section className={'Bicycle-b7'} ref={ref}>
            <div className="Bicycle-b7__left">
                <div className="Bicycle-b7__left-line">
                    <div className="Bicycle-b7__left-line_photo" style={{backgroundImage: "url(" + photo1 + ")"}}>
                        <div className="shopNow">
                            <div className="shopNow-logo" style={{backgroundImage: "url(" + logo + ")"}}/>
                            <div className="shopNow-text">SHOP NOW</div>
                        </div>
                    </div>
                    <div className="Bicycle-b7__left-line_photo" style={{backgroundImage: "url(" + photo2 + ")"}}>
                        <div className="shopNow">
                            <div className="shopNow-logo" style={{backgroundImage: "url(" + logo + ")"}}/>
                            <div className="shopNow-text">SHOP NOW</div>
                        </div>
            ...
            <div className="Bicycle-b7__center">
                <div className="Bicycle-b7__center-photo" style={{backgroundImage: "url(" + photo4 + ")"}}>
                    <div className="shopNow">
                        <div className="shopNow-logo" style={{backgroundImage: "url(" + logo + ")"}}/>
                        <div className="shopNow-text">SHOP NOW</div>
                    </div>
                </div>
                <div className="Bicycle-b7__center-photo" style={{backgroundImage: "url(" + photo5 + ")"}}>
                    <div className="shopNow">
                        <div className="shopNow-logo" style={{backgroundImage: "url(" + logo + ")"}}/>
                        <div className="shopNow-text">SHOP NOW</div>
                    </div>
            ...
            <div className="Bicycle-b7__right">
                ...
                <div className="Bicycle-b7__right-line">
                    <div className="Bicycle-b7__right-line_photo" style={{backgroundImage: "url(" + photo7 + ")"}}>
                        <div className="shopNow">
                            <div className="shopNow-logo" style={{backgroundImage: "url(" + logo + ")"}}/>
                            <div className="shopNow-text">SHOP NOW</div>
                        </div>
                    </div>
                    <div className="Bicycle-b7__right-line_photo" style={{backgroundImage: "url(" + photo8 + ")"}}>
                        <div className="shopNow">
                            <div className="shopNow-logo" style={{backgroundImage: "url(" + logo + ")"}}/>
                            <div className="shopNow-text">SHOP NOW</div>
                        </div>
