        ...
        <footer className={'Bicycle-b10'}>
            <div className="Bicycle-b10__content">
                ...
                <div className="Bicycle-b10__content-center">
                    <div className="Bicycle-b10__content-center_icon" style={{backgroundImage: "url(" + twitterIcon + ")"}}/>
                    <div className="Bicycle-b10__content-center_icon" style={{backgroundImage: "url(" + facebookIcon + ")"}}/>
                    <div className="Bicycle-b10__content-center_icon" style={{backgroundImage: "url(" + pinterestIcon + ")"}}/>
                </div>

                <div className="Bicycle-b10__content-right">
                    <div className="Bicycle-b10__content-right_text">Handcrafted by</div>
                    <div className="Bicycle-b10__content-right_logo" style={{backgroundImage: "url(" + logo + ")"}}/>
                </div>
            </div>
        </footer>
    )
