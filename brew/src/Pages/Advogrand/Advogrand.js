...
class Advogrand extends Component {
    ...
    scrollTo(blockNumber) {
        switch (blockNumber) {
            case 1:
                this.block5.current.sectionRef.scrollIntoView();
                break;
            case 2:
                this.block6.current.sectionRef.scrollIntoView();
                break;
            case 3:
                this.block8.current.sectionRef.scrollIntoView();
                break;
            case 4:
                this.block10.current.sectionRef.scrollIntoView();
                break;
            case 5:
                this.block9.current.sectionRef.scrollIntoView();
                break;
            case 6:
                this.block11.current.sectionRef.scrollIntoView();
                break;
        }
    }
